        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight font-anton uppercase">
              WORKING WITH <span className="text-blue-500">T&S</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center">
            ...
            <div className="relative">
              <div className="absolute -left-8 top-0 h-full w-1 bg-blue-500"></div>
              <h3 className="text-3xl md:text-4xl font-bold mb-8 font-anton uppercase">
                EMPLOYMENT <span className="text-blue-500">APPLICATION</span>
              </h3>
              <div className="space-y-5 text-gray-600 mb-10 font-opensans">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`inline-block px-10 py-4 bg-blue-500 text-white font-bold transition-all duration-300 border border-blue-500 group relative overflow-hidden font-opensans ${
                      isLoading
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <h3 className="text-3xl md:text-4xl font-bold mb-8 font-anton uppercase">
                CONTACT US FOR{" "}
                <span className="text-blue-500">CAREER OPPORTUNITIES</span>
              </h3>
              <div className="space-y-5 text-gray-600 mb-10 font-opensans">
                <p className="leading-relaxed">
