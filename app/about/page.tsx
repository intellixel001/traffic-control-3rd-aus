        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight font-anton uppercase">
              T&S TRAFFIC CONTROL <br />
              <span className="text-blue-500">Trusted, Skilled, Secure</span>
            </h2>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="relative h-[300px] w-full mb-4 border-4 border-blue-500 shadow-lg">
                  <Image
                    src={member.image}
                    alt={member.name}
                    fill
      ...
      <section id="accreditations" className="py-24 bg-white text-black">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight font-anton">
              WE ARE{" "}
              <span className="text-blue-500">ISO AND LGA CERTIFIED</span>
            </h2>
            <div className="w-24 h-1 bg-blue-500 mx-auto"></div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center">
                <div className="relative h-[150px] md:max-w-[250px] mx-auto w-full mb-4 border-4 border-blue-500">
                  <Image
                    src={cert.image}
                    alt={cert.name}
                    fill
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div
                key={index}
                className="group bg-white p-8 text-center border border-gray-200 hover:border-blue-500 transition-all duration-500 hover:shadow-lg hover:shadow-blue-500/20 relative overflow-hidden"
              >
