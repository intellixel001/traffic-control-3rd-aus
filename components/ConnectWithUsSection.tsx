      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-white flex flex-col justify-between h-full">
            ...
            <Link
              href="/contact"
              className="flex items-center justify-center gap-3 bg-blue-500 hover:bg-blue-500 text-white px-8 py-4 rounded-full font-semibold text-base uppercase tracking-wide transition-all duration-300 hover:shadow-2xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-400"
            >
