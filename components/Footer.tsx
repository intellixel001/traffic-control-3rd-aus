        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row justify-start items-center mt-6 gap-6  px-6 md:px-0">
              <img src="/footer1.png" alt="Acknowledgement" className="mt-4 max-w-[180px] lg:w-[250px] h-[50px]  lg:h-[70px]" />
              <img src="/footer2.png" alt="Acknowledgement" className="mt-4 max-w-[180px] lg:w-[250px] h-[50px] lg:h-[70px]" />
            </div>
          </div>

          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold text-blue-500 mb-4 uppercase tracking-wide">
              Services
            </h3>
